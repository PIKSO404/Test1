...
princp=[]
try:
	prox= requests.get('https://github.com/PIKSO404/T/blob/main/Gi.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/PIKSO404/Test1/blob/main/box.txt').text
		ua=open('.bbnew.txt','w')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/PIKSO404/T/blob/main/Gi.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
